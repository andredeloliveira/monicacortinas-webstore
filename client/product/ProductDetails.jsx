    ...
    */
    ...
    if(shoppingCart === undefined){
      ...
      if(productExists(shoppingCart.items, this.data.product._id)){
        ...
        this.setMessageText('Esse item já existe no seu carrinho!');
      }else{
        let item = this.data.product;
        item.quantity = 1;
        item.selectedColor = this.refs.colours.getSelectedColor();
        ...
        this.setMessageText('Item adicionado ao carrinho!');
      }
    }
            ...
            <div className="ui right aligned grid">
              <div className="row">
                  <div className=" column">
                    ...
                    {this.data.product.stock > 0 ?<div className="inStock">Em estoque</div>:
                    <div className="outOfStock">Sem estoque</div> }
                  </div>
              </div>
              <div className="row">
                <div className="column">
            ...
            <div className="ui centered aligned grid">
              <div className="row">
                  <div className="sixteen wide column">
                    <button className="fluid ui button" id="addToCart" onClick={this.addToCart}>Adicionar ao carrinho</button>
                  </div>
              </div>
              <div className="row">
                <SocialMedia />
